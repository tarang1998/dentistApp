...
Widget allergiesSelectionWidget(
    {required List<Allergies> selectedAllergies,
    required Function(List<Allergies>) handlePatientAllergiesSelectionEvent,
      ...
      children: <Widget>[
        ...
        Wrap(
          children: Allergies.values.map(
            (element) {
              final bool isSelected = selectedAllergies.contains(element);
              return Container(
                ...
                child: MouseRegion(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      if (selectedAllergies.contains(element)) {
                        selectedAllergies.remove(element);
                        handlePatientAllergiesSelectionEvent(selectedAllergies);
                      } else {
