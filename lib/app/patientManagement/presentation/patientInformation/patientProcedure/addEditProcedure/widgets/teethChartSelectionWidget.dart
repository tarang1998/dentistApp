...
Widget teethChartSelectionWidget(
    {required TeethChartType? selectedTeethChartType,
    required Function(TeethChartType) handleTeethChartSelectionEvent,
  ...
  return Container(
    ...
    child: Column(
      ...
      children: <Widget>[
        Wrap(
          children: TeethChartType.values.map(
            (element) {
              final bool isSelected = selectedTeethChartType == element;
              return Container(
                ...
                child: MouseRegion(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      handleTeethChartSelectionEvent(element);
                    },
                    child: Chip(
