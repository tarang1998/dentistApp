...
Widget diagnosisSelectionWidget(
    {required Diagnosis? selectedDiagnosis,
    required Function(Diagnosis) handleDiagnosisSelectionEvent,
  ...
  return Container(
    ...
    child: Column(
      ...
      children: <Widget>[
        Wrap(
          children: Diagnosis.values.map(
            (element) {
              final bool isSelected = selectedDiagnosis == element;
              return Container(
                ...
                child: MouseRegion(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      handleDiagnosisSelectionEvent(element);
                    },
                    child: Chip(
